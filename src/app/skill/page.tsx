  ...
  return (
    <div className="w-full h-screen">
      <section className="h-[12%] w-full flex">
        <div className="w-[20%] h-full bg-valorant border-b border-white" />
        <div className="w-[80%] h-full bg-valorant border-b border-l border-white" />
      </section>
      ...
      <section className="h-[63%] w-full flex relative">
        ...
        <div className="w-[80%] h-full text-valorantWhite bg-valorant border-l border-white space-y-8">
          <h1 className="text-6xl font-bold md:text-8xl">MY SKILLS</h1>
      ...
      <section className="h-[15%] w-full flex relative">
        ...
        <div className="w-[80%] h-full border-l border-white">
          <div className="absolute right-0 flex flex-row items-end justify-end gap-5 bottom-5">
