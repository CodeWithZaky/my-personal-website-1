    ...
    <div className="min-h-screen w-full bg-valorantWhite">
      ...
      <div className=" w-full flex">
        <div className="w-full md:w-[80%] border-r-2 border-t-2 border-r-black border-t-valorant flex flex-col justify-end items-end">
          ...
          <h1 className="text-7xl md:text-8xl font-bold mb-5">PROJECTS</h1>
          <div className="grid grid-flow-col-1 md:grid-flow-col-1 lg:grid-cols-2 border-b-2 border-black">
            {card_items}
          </div>
        </div>
